...
{
    public class CollectionWriteRepository : WriteRepository<Collection>, ICollectionWriteRepository
    {
        public CollectionWriteRepository(ApplicationDbContext context) : base(context)
        {
        }
    }
}
